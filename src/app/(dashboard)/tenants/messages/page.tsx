      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Your conversations with landlords</p>
          </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-3 overflow-y-auto">
            ...
            {isLoading ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8 text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">Send an enquiry to start messaging</p>
              </div>
            ) : (
